...
import '../pages/ReasoningPractice.css'; // Reuse same styling
...
const EnglishPractice = () => {
    ...
    const questions = englishQuestions[topic] || [];
        ...
        return (
            <div className="practice-container">
                <div className="error-message glass-panel">
                    ...
                    <Link to="/english" className="btn-primary">← Back to English</Link>
                </div>
            </div>
        );
    }
            ...
            <div className="practice-container">
                <div className="game-over glass-panel">
                    ...
                    <div className="action-buttons">
                        ...
                        <Link to="/english" className="btn-secondary">
                            ← Back to Topics
                        </Link>
                    </div>
                </div>
    ...
    return (
        <div className="practice-container">
            <div className="practice-header">
                <Link to="/english" className="back-link">← Back</Link>
